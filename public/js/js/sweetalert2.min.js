...
!function(t, e) {
          ...
          const bt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
            , yt = t=>{
              if (!t.input)
                  return;
              if (!Et[t.input])
                  return void p("Unexpected type of input! Expected ".concat(Object.keys(Et).join(" | "), ', got "').concat(t.input, '"'));
              const e = kt(t.input)
                , n = Et[t.input](e, t);
              J(e),
            ...
            , Et = {};
          Et.text = Et.email = Et.password = Et.number = Et.tel = Et.url = Et.search = Et.date = Et["datetime-local"] = Et.time = Et.week = Et.month = (t,e)=>(Bt(t, e.inputValue),
          At(t, t, e),
          Ct(t, e),
          t.type = e.input,
          t),
          Et.file = (t,e)=>(At(t, t, e),
          Ct(t, e),
          t),
          Et.range = (t,e)=>{
              const n = t.querySelector("input")
                , o = t.querySelector("output");
              return Bt(n, e.inputValue),
              n.type = e.input,
              Bt(o, e.inputValue),
              At(n, t, e),
              t
          ...
          const xt = (t,e)=>{
            ...
            , Rt = (t,e,n)=>{
              ...
              "Enter" === e.key ? Ut(e, t) : "Tab" === e.key ? zt(e) : [...Ft, ..._t].includes(e.key) ? Wt(e.key) : "Escape" === e.key && Kt(e, t, n)))
          }
            , Ut = (t,e)=>{
              if (!g(e.allowEnterKey))
                  return;
              const n = U(A(), e.input);
            ...
            , Wt = t=>{
              ...
              if (a) {
                  for (let t = 0; t < e.children.length; t++) {
                      ...
                      !a)
                          return;
                      if (a instanceof HTMLButtonElement && et(a))
                          break
                  }
          ...
          let te = null;
          const ee = t=>{
              null === te && (document.body.scrollHeight > window.innerHeight || "scroll" === t) && (te = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
              document.body.style.paddingRight = "".concat(te + (()=>{
                  const t = document.createElement("div");
          ...
          ;
          function ne(t, e, n, o) {
              N() ? ue(t, o) : (s(n).then((()=>ue(t, o))),
              Vt(i)),
              $t ? (e.setAttribute("style", "display:none !important"),
              e.removeAttribute("class"),
              e.innerHTML = "") : e.remove(),
              V() && (null !== te && (document.body.style.paddingRight = "".concat(te, "px"),
              te = null),
              (()=>{
          ...
          function oe(t) {
              ...
              const e = Yt.swalPromiseResolve.get(this)
                , n = ie(this);
              this.isAwaitingPromise ? t.isDismissed || (re(this),
              e(t)) : n && e(t)
          }
          const ie = t=>{
              const e = A();
          ...
          const re = t=>{
            ...
            , ce = (t,e,n)=>{
              ...
              i ? le(t, e, o, n.returnFocus, n.didClose) : ne(t, o, n.returnFocus, n.didClose)
          }
            , le = (t,e,n,o,s)=>{
              pt && (i.swalCloseEventFinishedCallback = ne.bind(null, t, n, o, s),
            ...
            , fe = (t,e)=>{
              ...
              ;
              f(e.inputOptions) || y(e.inputOptions) ? (de(L()),
          ...
          const ye = t=>{
            ...
            , ve = (t,e)=>{
              ...
              n.inputValidator ? Ce(t, i, e) : o && !o.checkValidity() ? (t.enableButtons(),
              t.showValidationMessage(n.validationMessage)) : "deny" === e ? Ae(t, i) : Ee(t, i)
          }
            , Ce = (t,e,n)=>{
              const o = ft.innerParams.get(t);
              t.disableInput();
            ...
            , Ee = (t,e)=>{
              const n = ft.innerParams.get(t || void 0);
              if (n.showLoaderOnConfirm && de(),
              n.preConfirm) {
                  t.resetValidationMessage(),
                  t.isAwaitingPromise = !0;
                  Promise.resolve().then((()=>b(n.preConfirm(e, n.validationMessage)))).then((n=>{
                      et(P()) || !1 === n ? (t.hideLoading(),
                      re(t)) : ke(t, void 0 === n ? e : n)
                  }
                  )).catch((e=>Be(t || void 0, e)))
              } else
                  ke(t, e)
          ...
          const Je = t=>{
            ...
            , Xe = t=>{
              t.isAwaitingPromise ? (Ge(ft, t),
              t.isAwaitingPromise = !0) : (Ge(Yt, t),
              Ge(ft, t),
            ...
            , sn = t=>{
              t.container.onmousedown = ()=>{
                  t.popup.onmouseup = function(e) {
                      t.popup.onmouseup = ()=>{}
                      ,
                      (e.target === t.popup || e.target instanceof HTMLElement && t.popup.contains(e.target)) && (nn = !0)
                  }
              }
          }
            , rn = (t,e,n)=>{
          ...
          var mn = Object.freeze({
              ...
              bindClickHandler: function() {
                  dn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
          ...
          const gn = ["swal-title", "swal-html", "swal-footer"]
            ...
            , wn = t=>{
              ...
              return n && (Bn(n, ["src", "width", "height", "alt"]),
            ...
            , Cn = t=>{
              ...
              n && (Bn(n, ["type", "label", "placeholder", "value"]),
            ...
            , xn = t=>{
              ...
              if (t.target !== e || !pt)
                  return;
              const n = w();
              e.removeEventListener(pt, xn),
              n.style.overflowY = "auto"
          }
            , Tn = (t,e)=>{
              pt && ot(e) ? (t.style.overflowY = "hidden",
              e.addEventListener(pt, xn)) : t.style.overflowY = "auto"
          }
            , Pn = (t,e,n)=>{
              (()=>{
          ...
          function On(t) {
              !function(t) {
                  t.inputValidator || ("email" === t.input && (t.inputValidator = Sn.email),
          ...
          const In = (t,e,n)=>new Promise(((o,s)=>{
              ...
              ((t,e,n)=>{
                  Vt(t),
                  e.toast || (t.keydownHandler = t=>Rt(e, t, n),
              ...
              ((t,e)=>{
                  "select" === e.input || "radio" === e.input ? fe(t, e) : ["text", "email", "number", "tel", "textarea"].some((t=>t === e.input)) && (f(e.inputValue) || y(e.inputValue)) && (de(L()),
                  be(t, e))
              }
              )(t, n),
              En(n),
            ...
            , qn = t=>{
              ...
              return ft.domCache.set(t, e),
              e
          }
            , Vn = (t,e,n)=>{
              const o = I();
              X(o),
              e.timer && (t.timeout = new hn((()=>{
                  n("timer"),
                  delete t.timeout
              }
              ),e.timer),
            ...
            , Fn = (t,e)=>e.focusDeny && et(t.denyButton) ? (t.denyButton.focus(),
